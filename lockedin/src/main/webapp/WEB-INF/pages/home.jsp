...
<body >
        ...
        <div class="main-container">
            ...
            <div class="shop-tag">
                <h1> Shop with Catogeries</h1>
            </div>

            <div class="cards-container">
                <!-- Card 1 -->
                <div class="product-card">
                    <img src="merch.webp" alt="Card Background" class="card-bg-image">
                ...
                <!-- Card 2 -->
                <div class="product-card">
                    <img src="equipments.webp" alt="Card Background" class="card-bg-image">
                ...
                <!-- Card 3 -->
                <div class="product-card">
                    <img src="suppliments.webp" alt="Card Background" class="card-bg-image">
